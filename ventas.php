...
{?>
    ...
    <td><a href="ventas-clientesL.php?id=<?php echo $tabla['id_v'];?>"><i class="fas fa-address-card"></i></a></td>
    <td><a href="eliminarProd.php?id=<?php echo $tabla['id_v'];?>"><i class="fas fa-trash-alt"></i></a></td>
